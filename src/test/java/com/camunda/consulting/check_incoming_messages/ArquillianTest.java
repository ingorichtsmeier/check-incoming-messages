...
public class ArquillianTest {
  ...
  public static WebArchive createDeployment() {
    ...
    return ShrinkWrap
            .create(WebArchive.class, "check-incoming-messages.war")
            ...
            .addPackages(false, "com.camunda.consulting.check_incoming_messages") // not recursive to skip package 'nonarquillian'
